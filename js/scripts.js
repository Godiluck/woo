...
function setSelectedCrypto(element) {
    ...
    if (document.getElementById("fiat-button").innerText != "Crypto" && button.innerText != "Crypto") {
...
function setSelectedBank(element) {
    ...
    if (document.getElementById("crypto-button").innerText != "Crypto" && button.innerText != "Crypto") {
        document.getElementById("crypto-input").disabled = false;
        document.getElementById("fiat-input").disabled = false;
        exchangeIfNeeded()
    }
...
function getMinAmount(bank) {
    ...
    switch(fiat) {
        case "uah": return "2500 UAH";
        case "usd": return "200 USD";
        case "eur": return "75 EUR";
        case "rub": return "6000 RUB";
        case "gbp": return "75 GBP";
        case "czk": return "2000 CZK";
        case "pln": return "300 PLN";
        case "jpy": return "10000 JPY"
        default : return "--";
    }
}
...
function getMinAmountWithoutFiat(fiat) {
    switch(fiat) {
        case "uah": return "2500";
        case "usd": return "200";
        case "eur": return "75";
        case "rub": return "6000";
        case "gbp": return "75";
        case "czk": return "2000";
        case "pln": return "300";
        case "jpy": return "10000"
        default : return "--";
    }
}
